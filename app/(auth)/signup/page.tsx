  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err.message?.includes('invalid')) {
        setError('邮箱格式无效，请使用真实的邮箱地址（如：example@gmail.com）')
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="relative animate-scale-fade-in animation-fill-both animation-delay-100">
            ...
            <div className="relative bg-white/[0.08] backdrop-blur-xl rounded-3xl border border-white/10 shadow-2xl">
              ...
              <div className="relative p-8 md:p-10">
                {/* 标题 */}
                <div className="text-center mb-6 animate-slide-up-fade animation-fill-both animation-delay-200">
                  <h1 className="text-3xl font-bold text-white mb-2">
                    创建账户
                  </h1>
                  <p className="text-gray-400">开始您的购物之旅</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  {/* 密码输入 */}
                  <div className="animate-slide-up-fade animation-fill-both animation-delay-500">
                  ...
                  {/* 确认密码输入 */}
                  <div className="animate-slide-up-fade animation-fill-both animation-delay-600">
          ...
          <div className="mt-8 text-center animate-fade-in animation-fill-both animation-delay-700">
            <p className="text-gray-400">
              已有账户？
              <Link href="/login" className="ml-2 font-semibold text-purple-400 hover:text-purple-300 transition-colors">
                立即登录
              </Link>
            </p>
          </div>
